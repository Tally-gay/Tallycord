...
const plugin = definePlugin({
    ...
    messageCallback(event: { message: MessageJSON; }) {
    ...
    async start() {
        ...
        this.enableKeybinds();
        FluxDispatcher.subscribe("MESSAGE_CREATE", this.messageCallback);


    },

    stop() {
        FluxDispatcher.unsubscribe("MESSAGE_CREATE", this.messageCallback);
